...
class PhieuLuong2(QWidget):
    ...
    def create_header_section(self, layout):
        ...
        header_frame.setStyleSheet("background-color: #f8f9fa; border: 2px solid #007bff;")
        
        header_layout = QVBoxLayout(header_frame)
        
        # Company info
        company_label = QLabel("CÔNG TY TNHH HITECH NDT")
...
class SalaryPrintDialog(QDialog):
    ...
    def create_pdf_report(self, filename):
        ...
        try:
            ...
            # Header
            story.append(Paragraph("🏢 CÔNG TY TNHH HITECH NDT", company_style))
            ...
            emp_info_table = Table(emp_info_data, colWidths=[2.5*cm, 3*cm, 2*cm, 4*cm])
            ...
            # (A) LƯƠNG CƠ BẢN - Tạo bảng với merge cell thật
            basic_data = [
                ['(A) LƯƠNG CƠ BẢN', 'Số ngày làm việc bình thường:', '27'],
                ['', 'Thành tiền (vnđ):', self.format_currency(self.salary_data.get('basic_amount', 'N/A'))]
            ]
            
            basic_table = Table(basic_data, colWidths=[3*cm, 6*cm, 4*cm])
            basic_table.setStyle(TableStyle([
                ...
                ('TOPPADDING', (0, 0), (-1, -1), 8),
                ('BOTTOMPADDING', (0, 0), (-1, -1), 8),
                ('SPAN', (0, 0), (0, 1)),  # Merge cell đầu tiên
            ]))
            ...
            overtime_data = [
                ...
                ['', '150%', self.salary_data.get('overtime_150_hours', 'N/A'), self.format_currency(self.salary_data.get('overtime_150_amount', 'N/A'))],
                ['', '200%', self.salary_data.get('sunday_200_hours', 'N/A'), self.format_currency(self.salary_data.get('sunday_200_amount', 'N/A'))],
                ['', '300%', self.salary_data.get('holiday_300_hours', 'N/A'), self.format_currency(self.salary_data.get('holiday_300_amount', 'N/A'))],
                ['', 'Tổng thu nhập thêm giờ:', '', self.format_currency(self.salary_data.get('total_overtime', 'N/A'))]
            ]
            
            overtime_table = Table(overtime_data, colWidths=[3*cm, 3*cm, 2*cm, 4*cm])
            overtime_table.setStyle(TableStyle([
                ('GRID', (0, 0), (-1, -1), 1, colors.black),
                ('BACKGROUND', (0, 0), (0, 4), colors.lightgreen),
                ('BACKGROUND', (1, 0), (3, 0), colors.lightgrey),
                ('BACKGROUND', (3, 4), (3, 4), colors.yellow),
                ('FONTNAME', (0, 0), (-1, -1), 'Helvetica-Bold'),
                ('FONTSIZE', (0, 0), (-1, -1), 10),
                ...
                ('TOPPADDING', (0, 0), (-1, -1), 8),
                ('BOTTOMPADDING', (0, 0), (-1, -1), 8),
                ('SPAN', (0, 0), (0, 4)),  # Merge cell đầu tiên
            ]))
            ...
            allowance_data = [
                ...
                ['', 'Công trường (W)', self.salary_data.get('work_days', 'N/A'), self.format_currency(self.salary_data.get('work_allowance', 'N/A'))],
                ['', 'Đào tạo (T)', self.salary_data.get('training_days', 'N/A'), self.format_currency(self.salary_data.get('training_allowance', 'N/A'))],
                ['', 'Văn Phòng (O)', self.salary_data.get('office_days', 'N/A'), self.format_currency(self.salary_data.get('office_allowance', 'N/A'))],
                ['', 'Chức danh (hệ số)', '0.41', 'N/A'],
                ['', 'Xăng xe', self.salary_data.get('work_days', 'N/A'), self.format_currency(self.salary_data.get('gas_allowance', 'N/A'))],
                ['', 'Điện thoại', self.salary_data.get('work_days', 'N/A'), self.format_currency(self.salary_data.get('phone_allowance', 'N/A'))],
                ['', 'Khách sạn', self.salary_data.get('work_days', 'N/A'), self.format_currency(self.salary_data.get('hotel_allowance', 'N/A'))],
                ['', 'Tổng thu nhập phụ cấp:', '', self.format_currency(self.salary_data.get('total_allowance', 'N/A'))]
            ]
            
            allowance_table = Table(allowance_data, colWidths=[3*cm, 3*cm, 2*cm, 4*cm])
            allowance_table.setStyle(TableStyle([
                ('GRID', (0, 0), (-1, -1), 1, colors.black),
                ('BACKGROUND', (0, 0), (0, 8), colors.lightgreen),
                ('BACKGROUND', (1, 0), (3, 0), colors.lightgrey),
                ('BACKGROUND', (3, 8), (3, 8), colors.yellow),
                ('FONTNAME', (0, 0), (-1, -1), 'Helvetica-Bold'),
                ('FONTSIZE', (0, 0), (-1, -1), 10),
                ...
                ('TOPPADDING', (0, 0), (-1, -1), 8),
                ('BOTTOMPADDING', (0, 0), (-1, -1), 8),
                ('SPAN', (0, 0), (0, 8)),  # Merge cell đầu tiên
            ]))
            ...
            # (D) KPI
            kpi_data = [
                ['(D) KPI (NĂNG SUẤT)', 'Type', 'Số mét vượt', 'Thành tiền (vnđ)'],
                ['', 'PAUT', self.salary_data.get('paut_meters', 'N/A'), self.format_currency(self.salary_data.get('paut_amount', 'N/A'))],
                ['', 'UT', self.salary_data.get('tofd_meters', 'N/A'), self.format_currency(self.salary_data.get('tofd_amount', 'N/A'))],
                ['', 'Tổng thu nhập năng suất:', '', self.format_currency(self.salary_data.get('total_kpi', 'N/A'))]
            ]
            
            kpi_table = Table(kpi_data, colWidths=[3*cm, 2*cm, 3*cm, 4*cm])
            kpi_table.setStyle(TableStyle([
                ('GRID', (0, 0), (-1, -1), 1, colors.black),
                ('BACKGROUND', (0, 0), (0, 3), colors.lightgreen),
                ('BACKGROUND', (1, 0), (3, 0), colors.lightgrey),
                ('BACKGROUND', (3, 3), (3, 3), colors.yellow),
                ('FONTNAME', (0, 0), (-1, -1), 'Helvetica-Bold'),
                ('FONTSIZE', (0, 0), (-1, -1), 10),
                ...
                ('TOPPADDING', (0, 0), (-1, -1), 8),
                ('BOTTOMPADDING', (0, 0), (-1, -1), 8),
                ('SPAN', (0, 0), (0, 3)),  # Merge cell đầu tiên
            ]))
            ...
            # TỔNG CỘNG
            total_data = [
                ['(I) Tổng cộng (vnđ)=(A)+(B)+(C)+(D):', self.format_currency(self.salary_data.get('gross_salary', 'N/A'))]
            ]
    ...
    def create_preview_from_pdf(self, pdf_path):
        ...
        try:
            ...
            # Header
            draw.text((width//2 - 120, y), "CÔNG TY TNHH HITECH NDT", fill='darkblue', font=font_large)
            y += 40
            ...
            self.draw_merged_table(draw, 20, y, width-40, 60, [
                ['(A) LƯƠNG CƠ BẢN', 'Số ngày làm việc bình thường:', '27'],
                ['', 'Thành tiền (vnđ):', self.format_currency(self.salary_data.get('basic_amount', 'N/A'))]
            ], font_small, merge_cells=[(0, 0, 0, 1)])
            y += 80
            ...
            self.draw_merged_table(draw, 20, y, width-40, 120, [
                ...
                ['', '300%', self.salary_data.get('holiday_300_hours', 'N/A'), self.format_currency(self.salary_data.get('holiday_300_amount', 'N/A'))],
                ['', 'Tổng thu nhập thêm giờ:', '', self.format_currency(self.salary_data.get('total_overtime', 'N/A'))]
            ], font_small, merge_cells=[(0, 0, 0, 4)])
            y += 140
            ...
            self.draw_merged_table(draw, 20, y, width-40, 200, [
                ...
                ['', 'Khách sạn', self.salary_data.get('work_days', 'N/A'), self.format_currency(self.salary_data.get('hotel_allowance', 'N/A'))],
                ['', 'Tổng thu nhập phụ cấp:', '', self.format_currency(self.salary_data.get('total_allowance', 'N/A'))]
            ], font_small, merge_cells=[(0, 0, 0, 8)])
            y += 220
            ...
            self.draw_merged_table(draw, 20, y, width-40, 80, [
                ...
                ['', 'UT', self.salary_data.get('tofd_meters', 'N/A'), self.format_currency(self.salary_data.get('tofd_amount', 'N/A'))],
                ['', 'Tổng thu nhập năng suất:', '', self.format_currency(self.salary_data.get('total_kpi', 'N/A'))]
            ], font_small, merge_cells=[(0, 0, 0, 3)])
            y += 100
            ...
            self.draw_merged_table(draw, 20, y, width-40, 180, [
                ['(E) CÁC KHOẢN KHẤU TRỪ', '', '', 'Thành tiền (vnđ)'],
                ['', 'Hệ số bảo hiểm:', '10.50%', self.format_currency(self.salary_data.get('insurance_deduction', 'N/A'))],
                ['', 'Thuế TNCN:', '', self.format_currency(self.salary_data.get('tax_deduction', 'N/A'))],
                ['', 'Thu nhập chịu thuế:', '', self.format_currency(self.salary_data.get('taxable_income', 'N/A'))],
                ['', 'Giảm trừ gia cảnh:', '', self.format_currency(self.salary_data.get('family_deduction', 'N/A'))],
                ['', 'Bậc thuế:', '', self.salary_data.get('tax_bracket', 'N/A')],
                ['', 'Tạm ứng:', '', self.format_currency(self.salary_data.get('advance_deduction', 'N/A'))],
                ['', 'Vi phạm:', '', self.format_currency(self.salary_data.get('other_deduction', 'N/A'))],
                ['', 'Tiền đào tạo (UT ISO):', '', 'N/A'],
                ['', 'Tổng khấu trừ:', '', self.format_currency(self.salary_data.get('total_deduction', 'N/A'))]
            ], font_small, merge_cells=[(0, 0, 0, 9)])
            y += 200
            
            # (F) THANH TOÁN MUA SẮM
            self.draw_merged_table(draw, 20, y, width-40, 40, [
                ['(F) THANH TOÁN MUA SẮM', self.format_currency('0')]
            ], font_small)
            y += 60
            
            # THỰC NHẬN
            self.draw_merged_table(draw, 20, y, width-40, 40, [
                ['THỰC NHẬN (VNĐ)=I-E+F:', self.format_currency(self.salary_data.get('net_salary', 'N/A'))]
            ], font_small, bg_color='red', text_color='white')
    ...
    def draw_merged_table(self, draw, x, y, width, height, data, font, merge_cells=None, bg_color='lightgreen', text_color='black'):
        ...
        try:
            ...
            for i in range(rows + 1):
                draw.line([x, y + i * cell_height, x + width, y + i * cell_height], fill='black', width=1)
            for j in range(cols + 1):
                draw.line([x + j * cell_width, y, x + j * cell_width, y + height], fill='black', width=1)
            
            # Vẽ background cho merge cells
            if merge_cells:
                for merge in merge_cells:
                    ...
                    if bg_color == 'lightgreen':
                        draw.rectangle([merge_x, merge_y, merge_x + merge_width, merge_y + merge_height], fill='lightgreen')
                    elif bg_color == 'red':
                        draw.rectangle([merge_x, merge_y, merge_x + merge_width, merge_y + merge_height], fill='red')
                    elif bg_color == 'yellow':
                        draw.rectangle([merge_x, merge_y, merge_x + merge_width, merge_y + merge_height], fill='yellow')
    ...
    def format_currency(self, value):
        ...
        try:
            if not value or value == '0' or str(value).strip().upper() == 'N/A':
                return 'N/A'
